...
import RecordAttendanceMessageExtension from "../recordAttendanceMessageExtension/RecordAttendanceMessageExtension";
import { DialogSet, DialogState } from "botbuilder-dialogs";
// Initialize debug logging module
const log = debug("msteams");

/**
 * Implementation for Record Attendance Bot
 */
@BotDeclaration(
    "/api/messages",
    new MemoryStorage(),
...
export class RecordAttendanceBot extends TeamsActivityHandler {

    private readonly conversationState: ConversationState;
    /** Local property for RecordAttendanceMessageExtension */
    @MessageExtensionDeclaration("recordAttendanceMessageExtension")
    private _recordAttendanceMessageExtension: RecordAttendanceMessageExtension;
    ...
    public constructor(conversationState: ConversationState) {
        super();
        // Message extension RecordAttendanceMessageExtension
        this._recordAttendanceMessageExtension = new RecordAttendanceMessageExtension();
